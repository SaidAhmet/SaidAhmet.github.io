...
document.getElementById("galeriButonu").onclick = () => sayfaDegis("galeri.html");
    ...
    let ekranGen = document.documentElement.clientWidth;
    ...
    const neYapMain = document.getElementById("neYapMain");
    const basHarMain = document.getElementById("basHarMain");
    const filterSec = document.getElementById("filterSec");
    const tarihFilter = document.getElementById("tarihFilter");
    const yapElem = document.getElementById("yapilicaklarElemen");
    const neYapBaslik = document.getElementById("neYapBaslik");
    const neYapBas = document.getElementById("neYapBas");
